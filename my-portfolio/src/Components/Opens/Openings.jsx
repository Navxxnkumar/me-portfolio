...
//   return (
//     <section className="relative h-screen w-full flex items-center justify-center bg-[#020205] overflow-hidden">
//       {/* Dynamic Background Glow */}
//       <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(192,38,211,0.12)_0%,_transparent_65%)]"></div>

//       <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-2xl">

//         {/* 1. Greeting Badge - Fixed Alignment */}
//         <div className="mb-10 flex items-center gap-3 px-5 py-2 rounded-full border border-white/5 bg-white/[0.03] backdrop-blur-md animate-fade-in shadow-2xl">
//           <span className="relative flex h-2 w-2">
//             <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-fuchsia-400 opacity-75"></span>
//             <span className="relative inline-flex rounded-full h-2 w-2 bg-fuchsia-500"></span>
//           </span>
//           <span className="text-[10px] font-mono text-fuchsia-100 tracking-[0.4em] uppercase">
//             Hello! <span className="opacity-50">Welcome On-Board</span>
//           </span>
//         </div>

//         {/* 2. Central Logo & Portal */}
//         <div className="relative mb-12">
//           <div className="absolute -inset-10 bg-fuchsia-600/20 blur-[100px] rounded-full animate-pulse"></div>
//           <div className="w-32 h-32 md:w-48 md:h-48 rounded-full border border-white/10 flex items-center justify-center relative overflow-hidden group">
//             <div className="absolute inset-0 border-t-2 border-fuchsia-500 rounded-full animate-spin duration-[3000ms]"></div>
//             <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter">N</h1>
//           </div>
//         </div>

//         {/* 3. Text Intel Section */}
//         <div className="space-y-6 animate-fade-up">
//           <div className='flex items-center justify-center gap-4'>
//             <div className="h-[1px] w-8 bg-linear-to-r from-transparent to-fuchsia-500"></div>
//             <h4 className="text-[10px] md:text-xs font-bold tracking-[1em] text-fuchsia-400 uppercase">System Online</h4>
//             <div className="h-[1px] w-8 bg-linear-to-l from-transparent to-fuchsia-500"></div>
//           </div>

//           <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter leading-tight">
//             Naveenkumar <br className="md:hidden" />
//             <span className="text-transparent bg-clip-text bg-linear-to-r from-fuchsia-400 via-purple-400 to-indigo-400">
//               Universe
//             </span>
//           </h2>

//           <p className="text-gray-400 text-xs md:text-sm font-medium tracking-[0.2em] uppercase max-w-md mx-auto leading-relaxed">
//             Initializing modern <span className="text-white/80">digital experiences</span> and stellar interfaces
//           </p>
//         </div>

//         {/* 4. The Warp Button - Premium Logic */}
//         <button
//           onClick={handleEnterUniverse}
//           className="mt-16 group relative px-12 py-5  overflow-hidden rounded-full bg-white/[0.03] border border-white/10 text-white transition-all duration-700 hover:border-fuchsia-500/50 hover:shadow-[0_0_40px_rgba(192,38,211,0.25)]"
//         >
//           <div className="absolute inset-0 bg-linear-to-r from-fuchsia-600/20 to-purple-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

//           <span className="relative flex items-center gap-4 text-xs font-bold tracking-[0.4em] uppercase">
//             Launch System
//             <div className="relative w-6 h-6 flex items-center justify-center overflow-hidden">
//               {/* Static Rocket */}
//               <MdRocket className="absolute text-xl transition-all duration-500 group-hover:-translate-y-12 group-hover:opacity-0" />

//               {/* Launching Rocket - Diagonal Motion */}
//               <MdRocketLaunch className="absolute text-xl text-fuchsia-400 opacity-0 -translate-x-8 translate-y-8 transition-all duration-700 cubic-bezier(0.34, 1.56, 0.64, 1) group-hover:opacity-100 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:rotate-[5deg]" />
//             </div>
//           </span>
//         </button>
...
//       <div className="absolute bottom-10 left-10 w-20 h-20 border-l border-b border-white/5 rounded-bl-3xl"></div>
//       <div className="absolute top-10 right-10 w-20 h-20 border-r border-t border-white/5 rounded-tr-3xl"></div>
//     </section>
//   );
// };
import React from 'react';
